...
public class EntityTank extends Entity
{
    ...
    public EntityTank(World worldIn, double p_i1705_2_, double p_i1705_4_, double p_i1705_6_)
    {
        this(worldIn);
        ...
        else if (!this.worldObj.isRemote && !this.isDead)
        {
            ...
            else
            {
                ...
                if (flag || this.getDamageTaken() > 1000.0F)
                {
                    ...
                    if (!flag)
                    {
                        this.dropItemWithOffset(itemTank, 1, 0.0F);
                    }
    ...
    public void func_180426_a(double p_180426_1_, double p_180426_3_, double p_180426_5_, float p_180426_7_, float p_180426_8_, int p_180426_9_, boolean p_180426_10_)
    {
        if (p_180426_10_ && this.riddenByEntity != null)
        {
            ...
            this.tankPosRotationIncrements = 0;
        ...
        else
        {
            if (this.isTankEmpty)
            {
                this.tankPosRotationIncrements = p_180426_9_ + 5;
            }
            else
            {
            ...
            this.tankX = p_180426_1_;
            this.tankY = p_180426_3_;
            this.tankZ = p_180426_5_;
            this.tankYaw = (double)p_180426_7_;
            this.tankPitch = (double)p_180426_8_;
    ...
    public void onUpdate()
    {
        ...
        if (this.worldObj.isRemote && this.isTankEmpty)
        {
            if (this.tankPosRotationIncrements > 0)
            {
                d2 = this.posX + (this.tankX - this.posX) / (double)this.tankPosRotationIncrements;
                d4 = this.posY + (this.tankY - this.posY) / (double)this.tankPosRotationIncrements;
                d10 = this.posZ + (this.tankZ - this.posZ) / (double)this.tankPosRotationIncrements;
                d11 = MathHelper.wrapAngleTo180_double(this.tankYaw - (double)this.rotationYaw);
                this.rotationYaw = (float)((double)this.rotationYaw + d11 / (double)this.tankPosRotationIncrements);
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (list != null && !list.isEmpty())
                {
                    for (int k1 = 0; k1 < list.size(); ++k1)
                    {
                        ...
                        if (entity != this.riddenByEntity && entity.canBePushed() && entity instanceof EntityTank)
                        {
     ...
     */
    @SideOnly(Side.CLIENT)
    public void setIsTankEmpty(boolean p_70270_1_)
    {
        this.isTankEmpty = p_70270_1_;
    }
}
